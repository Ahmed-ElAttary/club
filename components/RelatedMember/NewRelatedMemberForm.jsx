...
import { intialFields } from "./RelatedMemberIntialFields";
import { useRouter } from "next/navigation";
const NewRelatedMemberForm = ({
  newDialog,
  toggleNewDialog,
  handleReload,
  title,
  ...
  const [fieldsValus, setFieldsValues] = useState({});
  useEffect(() => {
    if (values) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (data) => {
      ...
      submit("members_ref", method, data, utils);
    },
  });
...
export default NewRelatedMemberForm;
